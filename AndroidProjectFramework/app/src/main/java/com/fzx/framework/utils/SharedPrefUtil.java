...
/**
 * @author fzx
 * @ClassName: getSPControl SharedPreferences管理类
 * @date 2014-5-22 下午5:08:35
 */
public class SharedPrefUtil {
    ...
    public boolean setSPValue(String paramString, String tag, String value) {
        SharedPreferences sp = mContext.getSharedPreferences(paramString, Context.MODE_PRIVATE);
        if (sp != null) {
